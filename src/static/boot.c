...
#ifdef TARGET_PS3
  OSReport("[PS3/AUDIO] Nintendo boot sound delay skipped\n");
#else
...
int main(int argc, const char** argv) {
...
#ifdef TARGET_PS3
  OSReport("[PS3] boot: calling sound_initial...\n");
#endif
#ifdef TARGET_PC
  ...
  sound_initial();
#ifdef TARGET_PS3
  OSReport("[PS3] boot: sound_initial done\n");
  OSReport("[PS3] boot: calling initial_menu_init...\n");
#endif
#ifdef TARGET_PC
  ...
  initial_menu_init();
#ifdef TARGET_PS3
  OSReport("[PS3] boot: initial_menu_init done\n");
  OSReport("[PS3] boot: calling dvderr_init...\n");
#endif
#ifdef TARGET_PC
  ...
  dvderr_init();
#ifdef TARGET_PS3
  OSReport("[PS3] boot: dvderr_init done\n");
  OSReport("[PS3] boot: calling sound_initial2...\n");
#endif
#ifdef TARGET_PC
  ...
  sound_initial2();
#ifdef TARGET_PS3
  OSReport("[PS3] boot: sound_initial2 done\n");
#endif
