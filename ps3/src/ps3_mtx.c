/* ps3_mtx.c - C replacements for PPC paired-singles matrix/vector math */
...
void C_MTXPerspective(Mtx44 m, f32 fovY, f32 aspect, f32 n, f32 f) {
    f32 angle = 0.5f * fovY * PS3_DEG_TO_RADf;
...
typedef struct { unsigned char col[3]; char pad1; unsigned char colc[3]; char pad2; signed char dir[3]; char pad3; } ps3_Light_t;
typedef union { ps3_Light_t l; long long int force_align[2]; } ps3_Light;
typedef struct { ps3_Light l[2]; } ps3_LookAt;
typedef struct { int x1, y1, x2, y2; } ps3_Hilite_t;
typedef union { ps3_Hilite_t h; long long int force_align[2]; } ps3_Hilite;
...
void guLookAtHilite(Mtx* m, void* lv, void* hv,
    ...
    ps3_LookAt* l = (ps3_LookAt*)lv;
    ps3_Hilite* h = (ps3_Hilite*)hv;
    float mf[4][4];
    float len, xLook, yLook, zLook, xRight, yRight, zRight;
