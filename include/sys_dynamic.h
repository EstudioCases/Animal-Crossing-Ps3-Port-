...
#ifdef TARGET_PS3
/*
 * The original GC-sized display-list arenas are too tight for the PS3 bridge.
 * RPCS3 logs showed the renderer reaching SYSDYNAMIC_END_MAGIC (0x5678) as a
 * command word every frame, which means one of the frame display lists ran
 * beyond its arena before emu64 consumed it.
 */
#define POLY_OPA_SIZE 16384
#define POLY_XLU_SIZE 4096
#define OVERLAY_SIZE 4096
#define WORK_SIZE 256
#define UNK_BUF0_SIZE 64
#define FONT_SIZE 4096
#define SHADOW_SIZE 2048
#define LIGHT_SIZE 1024
#define NEW0_SIZE 4096
#define NEW1_SIZE 4096
#else
