...
#endif
#if !defined(__INTELLISENSE__) && !defined(TARGET_PC) && !defined(TARGET_PS3)
...
#if !defined(__INTELLISENSE__) && defined(MUST_MATCH) && !defined(TARGET_PC) && !defined(TARGET_PS3)
...
#if !defined(__cplusplus) && !defined(TARGET_PC) && !defined(TARGET_PS3)
